...
public class LobbyManager : MonoBehaviour {
    ...
    public static event Action<Exception> OnLobbyException;
        ...
        {
            {
                KEY_RELAY_CODE,
                new DataObject(
                    visibility: DataObject.VisibilityOptions.Public, joinCode.ToString()
                )
            }
        };
    ...
    public async Task<string> StartHostWithRelay(int maxConnections = 5)
    {
        ...
        // Configure the Transport to use the Relay server data
        unityTransport.SetHostRelayData(
            ...
            allocation.Key,                               // Key as byte array
